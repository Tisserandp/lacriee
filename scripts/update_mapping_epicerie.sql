-- ==========================================
-- MODIFICATION: AIDE_CULINAIRE et ACCOMPAGNEMENT → EPICERIE
-- Date: 2026-02-05
-- Raison: Toutes les catégories envoyées vers AIDE_CULINAIRE et ACCOMPAGNEMENT
--         doivent être plutôt envoyées vers l'espèce std EPICERIE
-- ==========================================
...
SELECT * FROM UNNEST([
  ...
  STRUCT('ANON', CAST(NULL AS STRING), 'POISSON', 'ANON'),  -- ✅ CORRIGÉ: ANON a sa propre espèce
  ...
  STRUCT('PAGEOT', CAST(NULL AS STRING), 'POISSON', 'PAGEOT'),  -- ✨ NOUVEAU: PAGEOT espèce distincte
  ...
  STRUCT('ANCHOIS', 'FILET', 'EPICERIE', 'EPICERIE'),  -- ✨ NOUVEAU: Filets d'anchois marinés
  ...
  -- ==========================================
  -- 🔄 MODIFIÉ : AIDE CULINAIRES : espece_std passe de 'AIDE_CULINAIRE' à 'EPICERIE'
  ...
  -- 🔄 MODIFIÉ : BLINIS : famille_std passe de 'TRAITEUR' à 'EPICERIE' et espece_std passe de 'ACCOMPAGNEMENT' à 'EPICERIE'
  ...
  -- 🔄 MODIFIÉ : ELABORE passe de TRAITEUR à EPICERIE
